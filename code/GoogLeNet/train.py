...
data_transform = {
    "train": transforms.Compose([transforms.Resize((224, 224)),  # interpolation=2   PIL.Image.BILINEAR
...
save_path = './googleNet.pth'  # the path the model will save
